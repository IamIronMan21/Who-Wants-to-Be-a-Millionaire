...
public class Quiz13 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Button 4 (Correct Answer)
        btn4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(Quiz13.this, "Correct Answer! You won $500,000", Toast.LENGTH_SHORT).show();
                // Proceed to the next quiz (Quiz14) upon selecting the correct answer
